...
public class AdapterLinesRequestDetail extends RealmBaseAdapter<RequestLine> implements ListAdapter {
    ...
    public AdapterLinesRequestDetail(@Nullable OrderedRealmCollection<RequestLine> data, Context context) {
        super(data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (adapterData != null) {
            ...
            viewHolder.addCountProduct.setOnClickListener(v -> {
                if(!isBlocked)changeCountIntoLine(item.getAssortimentUid(), 1);
            });
